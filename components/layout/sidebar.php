        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="nav-link" href="create-category.php">Tambah Kategori</a></li>
                </ul>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-money-bill-wave"></i><span>Pemesanan</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="index-pemesanan.php">Home Pemesanan</a></li>
                    <li><a class="nav-link" href="create-pemesanan.php">Tambah Pemesanan</a></li>
                </ul>
            </li>
            <li class="menu-header">Akun</li>
            <li class="dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-user-circle"></i><span>Akun</span></a>
                <ul class="dropdown-menu">
